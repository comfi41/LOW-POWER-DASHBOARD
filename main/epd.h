...
/*
define controll GPIO
*/
	
#define EINK_WAKE_GPIO GPIO_NUM_5 //define D1 gpio for wakeup pin
#define EINK_RESET_GPIO GPIO_NUM_4 //define D2 gpio for reset pin
#define EINK_WAKE_ON() gpio_set_level(EINK_WAKE_GPIO, 1) //macros for eink wakeup pin controling
#define EINK_WAKE_OFF() gpio_set_level(EINK_WAKE_GPIO, 0) 
