...
char html_page[] = "<!DOCTYPE HTML><html>\n"
                   ...
                   "        <form action=\"/get\">Network SSID: <input type=\"text\" name=\"input1\" value=\"%s\" size=\"4\">\n"
                   "        <br><form action=\"/get\">Network password: <input type=\"text\" name=\"input2\" value=\"%s\" size=\"4\"><br><br>\n"
                   "      </div>\n"
                   "      <div class=\"card\">\n"
                   "        <h4><i class=\"fas cloud\"></i>CLOUD SETTINGS</h4>\n"
                   "        <form action=\"/get\">Grant type: <input type=\"text\" name=\"input3\" value=\"%s\" size=\"4\">\n"
                   "        <br><form action=\"/get\">Client ID: <input type=\"text\" name=\"input4\" value=\"%s\" size=\"4\">\n"
                   "        <br><form action=\"/get\">Client password: <input type=\"text\" name=\"input5\" value=\"%s\" size=\"4\">\n"
                   "        <br><form action=\"/get\">Auth scope: <input type=\"text\" name=\"input6\" value=\"%s\" size=\"4\">\n"
                   "        <br><form action=\"/get\">Auth URL: <input type=\"text\" name=\"input7\" value=\"%s\" size=\"4\">\n"
                   "        <br><form action=\"/get\">Cloud URL: <input type=\"text\" name=\"input8\" value=\"%s\" size=\"4\"><br><br>\n"
                   "      </div>\n"
                   "      <div class=\"card\">\n"
                   "        <h4><i class=\"fas refresh\"></i>DISPLAY SETTINGS</h4>\n"
                   "        <form action=\"/get\">Refresh time: <input type=\"text\" name=\"input9\" value=\"%d\" size=\"4\"><br><br>\n"
                   "      </div>\n"   
